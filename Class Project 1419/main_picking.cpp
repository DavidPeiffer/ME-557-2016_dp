...
#pragma region textures
	...
	int texid = texture_0->loadAndCreateTexture("../data/textures/simple_texture.bmp");
	...
	int texid5 = texture_plane_3->loadAndCreateTexture("../data/textures/simple_teture.bmp");
