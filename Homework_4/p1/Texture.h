...
private:
	...
	const string      _glsl_names[3] = { "tex", "texture_blend" };
#endif
...
#else
	// DAVID CODE
	// Added "tex_NEW_TEXTURE"
    // const string      _glsl_names[3] = { "texture_background", "texture_foreground", "texture_blend"};
	const string      _glsl_names[4] = { "texture_sunset", "texture_face", "texture_colorwheel", "texture_blend" };
#endif
...
private:
    // DAVID CODE
	// Added _texture_3 and _textureIdx3
