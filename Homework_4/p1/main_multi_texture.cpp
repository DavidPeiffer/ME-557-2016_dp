...
int main(int argc, const char * argv[])
{
    ...
    GLAppearance* apperance_0 = new GLAppearance("../multi_texture2.vs", "../multi_texture2.fs");
	// GLAppearance* apperance_0 = new GLAppearance("multi_texture2.vs", "multi_texture2.fs");
	...
	int texid = texture->loadAndCreateTextures("../sunset.bmp", "../face.bmp", "../colorwheel.bmp");
	// int texid = texture->loadAndCreateTextures("../sunset.bmp", "", "");
