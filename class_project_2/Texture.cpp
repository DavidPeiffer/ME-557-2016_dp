...
// DAVID CODE
// Added third texture parameter
string  GLMultiTexture::_glsl_names[4] = { "texture_sunset", "texture_face", "texture_colorwheel", "texture_blend"};
#endif
...
{
    // DAVID CODE
	// Added _texture_3 and _textureIdx3 values
    _texture_1 = 0;
    _texture_2 = 0;
	_texture_3 = 0;
...
{
	// DAVID CODE
	// Added channels3, width3, and height3
...
bool GLMultiTexture::addVariablesToProgram(GLuint program, int variable_index)
{
	...
	// DAVID CODE
    // Changed index to 3 [the blend mode]
    _textureBlendModelIdx = glGetUniformLocation(program, _glsl_names[3].c_str() );
    checkUniform(_textureBlendModelIdx, _glsl_names[3]);
