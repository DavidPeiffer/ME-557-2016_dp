...
// This is what the multi_vertex_lights_ext.vs file has over the noraml multi_vertex_lights.vs
...
// END NEW STUFF COMPARED TO multi_vertex_lights.vs

// the color that shows up when an object has been picked
const vec3 select_color = vec3(0.0,0.0,0.0);
...
vec4 useLight(Light light, vec4 surfacePostion, vec4 normal_transformed, vec3 normal, Material material )
{
    ...
    // DAVID CODE
    // grabbed from single_texture.vs
